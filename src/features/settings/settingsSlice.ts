...
export interface SettingsState {
  ...
  activeSheet: 'account' | 'devices' | 'notification-settings' | 'check-updates' | 'preferences' | 'support' | 'Explore other Products' | 'Sign Out' | 'profile' | 'add-device' | 'edit-device' | 'menu' | 'about' | 'linked-accounts' | 'notification-inbox' | 'notifications' | 'alert-thresholds' | 'appearance' | 'units' | 'data-privacy' | 'help' | 'contact-support' | 'legal' | 'settings-main' | null;
}
